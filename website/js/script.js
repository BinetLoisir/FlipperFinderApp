...
const Enseigne = Parse.Object.extend("ENSEIGNE");
const FlipTrash = Parse.Object.extend("FLIPTRASH");
const Modele = Parse.Object.extend("MODELE_FLIPPER");
...
function initMap() {
    ...
    */
    ...
    function makeFlipString(flip) {
        ...
        //Bouton Supprimer
        returnString += ' <button class="minibtn" title="Supprimer" onclick="sendMailDelete(' + flip.flip_id + ')"><i class="fa fa-trash"></i></button>'
        return returnString;
    }
    */
