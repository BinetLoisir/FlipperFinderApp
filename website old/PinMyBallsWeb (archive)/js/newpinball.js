        ...
        .then(
            function (response) {
                ...
                response.json().then(function (data) {
                    let option;
                    numberOfmodels = data.results.length;
                    //order the results
...
function show() {
    var e = document.getElementById("modeleflipper1");
    console.log(e.value);
    console.log(e.options[e.selectedIndex].id);
