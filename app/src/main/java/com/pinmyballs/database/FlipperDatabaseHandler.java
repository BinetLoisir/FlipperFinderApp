...
public class FlipperDatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String FLIPPER_NOTE = "FLIP_NOTE";
    public static final String FLIPPER_EXPL = "FLIP_EXPL";
    public static final String FLIPPER_PHOTO = "FLIP_PHOTO";
    ...
    public static final String FLIPTRASH_TABLE_NAME = "FLIPTRASH";
    public static final String FLIPTRASH_FLIP_ID = "FLIP_ID";
    public static final String FLIPTRASH_PSEUDO = "PSEUDO";
    public static final String FLIPTRASH_PROCESSED = "PROCESSED";
